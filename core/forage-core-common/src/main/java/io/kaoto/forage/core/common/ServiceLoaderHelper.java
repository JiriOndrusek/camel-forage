 ...
 * <ul>
 *   <li>Model providers ({@code io.kaoto.forage.core.ai.ModelProvider})</li>
 *   <li>Memory factories ({@code io.kaoto.forage.core.ai.ChatMemoryFactory})</li>
 *   <li>Vector database providers ({@code io.kaoto.forage.core.vectordb.EmbeddingStoreProvider})</li>
...
public class ServiceLoaderHelper {
     ...
     *         "io.kaoto.forage.models.chat.openai.OpenAIProvider");
     * }</pre>
     *
