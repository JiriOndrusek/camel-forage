...
* `suites.tests.integration.io.kaoto.forage.PlainSuite`
* `suites.tests.integration.io.kaoto.forage.QuarkusSuite`
* `suites.tests.integration.io.kaoto.forage.SpringBootSuite`
...
(Implementation, taking care of runtimes, is located in `tests.integration.io.kaoto.forage.ForageTestCaseRunner`).
...
```java
[main] INFO tests.integration.io.kaoto.forage.ForageTestCaseRunner - --------------------------------------------------------------------------------
[main] INFO tests.integration.io.kaoto.forage.ForageTestCaseRunner - ----------------------------------- quarkus ------------------------------------
[main] INFO tests.integration.io.kaoto.forage.ForageTestCaseRunner - --------------------------------------------------------------------------------
```
...
Follow `jdbc.io.kaoto.forage.JdbcTest` as an example.
