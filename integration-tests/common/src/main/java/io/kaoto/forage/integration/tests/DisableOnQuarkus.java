...
/**
 * Annotation to disable a test when running with Quarkus runtime.
 *
...
public @interface DisableOnQuarkus {
    /**
     * Optional reason for disabling the test on Quarkus runtime.
     */
