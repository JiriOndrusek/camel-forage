...
public class CamelQuarkusAgentBeanFactory implements BeanFactory {
    private static final Logger LOG = LoggerFactory.getLogger(CamelQuarkusAgentBeanFactory.class);
