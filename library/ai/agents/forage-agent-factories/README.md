...
```java
from("direct:chat")
    .to("langchain4j-agent:my-agent?agentFactory=#class:factory.agent.io.kaoto.forage.MultiAgentFactory")
    .log("Response: ${body}");
```
...
- **Model Providers**: Discovers implementations of `ai.core.io.kaoto.forage.ModelProvider`
- **Memory Factories**: Discovers implementations of `ai.core.io.kaoto.forage.ChatMemoryBeanProvider`
...
- **`MultiAgentFactory`** (`factory.agent.io.kaoto.forage.MultiAgentFactory`)
...
- **`ConfigurationAware`** (`factory.agent.io.kaoto.forage.ConfigurationAware`)
...
- `META-INF/services/ai.core.io.kaoto.forage.ModelProvider`
- `META-INF/services/ai.core.io.kaoto.forage.ChatMemoryBeanProvider`
...
2. Register via ServiceLoader in `META-INF/services/ai.core.io.kaoto.forage.ModelProvider`

### Creating Custom Memory Factories

1. Implement the `ChatMemoryFactory` interface
2. Register via ServiceLoader in `META-INF/services/ai.core.io.kaoto.forage.ChatMemoryBeanProvider`
