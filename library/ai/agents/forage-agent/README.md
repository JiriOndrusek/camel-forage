...
from("direct:chat")
    ...
    .to("langchain4j-agent:memory-agent?agentFactory=#class:factory.agent.io.kaoto.forage.MultiAgentFactory")
    .log("Response: ${body}");
...
- **`SimpleAgent`** (`simple.agent.io.kaoto.forage.SimpleAgent`)
