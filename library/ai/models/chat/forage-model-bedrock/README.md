...
```java
from("direct:chat")
    .to("langchain4j-agent:bedrock?agentFactory=#class:factory.agent.io.kaoto.forage.MultiAgentFactory")
    .log("Response: ${body}");
```
...
from("direct:fast-chat")
    ...
    .to("langchain4j-agent:fast?agentFactory=#class:factory.agent.io.kaoto.forage.MultiAgentFactory");

from("direct:advanced-chat")
    .setHeader("agentId", constant("advanced"))
    .to("langchain4j-agent:advanced?agentFactory=#class:factory.agent.io.kaoto.forage.MultiAgentFactory");
```
