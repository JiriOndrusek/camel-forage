...
/**
 * Helper class for all export customizers. Follow the example implementation of {@link JmsExportCustomizer#}
 */
public abstract class AbstractExportCustomizer<T extends Config> implements ExportCustomizer {
    ...
    /**
     * Returns proper instance of {@link Config} used by the exporter.
     */
