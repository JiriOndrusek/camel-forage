...
/**
 * Helper class for all export customizers. Follow the example implementation of {@link org.apache.camel.forage.plugin.jms.JmsExportCustomizer#}
 */
public abstract class AbstractExportCustomizer<T extends Config> implements ExportCustomizer {
    ...
    /**
     * Returns proper instance of {@link org.apache.camel.forage.core.util.config.Config} used by the exporter.
     */
