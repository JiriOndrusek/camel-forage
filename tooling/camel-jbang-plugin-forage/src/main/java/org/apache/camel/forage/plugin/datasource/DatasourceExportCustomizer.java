...
public class DatasourceExportCustomizer extends AbstractExportCustomizer<DataSourceFactoryConfig> {
    ...
    protected final Set<String> getDependencies(RuntimeType runtime) {
        ...
        if (runtime == RuntimeType.quarkus
                && !readValuesOfProperty(DataSourceFactoryConfigEntries.TRANSACTION_ENABLED)
                        .isEmpty()) {
            dependencies.add(ExportHelper.getString("quarkus.narayana", ExportHelper.ResourceType.datasource));
        }
