...
class QuarkusPropertyTranslatorTest {
    ...
    class ExtractPrefixTest {
        ...
        void defaultInstance() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.jdbc.url", "jdbc"))
                    .isNull();
        }

        @Test
        void namedInstance() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.ds1.jdbc.url", "jdbc"))
                    .isEqualTo("ds1");
        }

        @Test
        void modulePrefixOnly() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.jdbc", "jdbc"))
                    .isNull();
        }

        @Test
        void namedInstanceModulePrefixOnly() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.ds1.jdbc", "jdbc"))
                    .isEqualTo("ds1");
        }

        @Test
        void multiSegmentModulePrefix() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.spring.rabbitmq.host", "spring.rabbitmq"))
                    .isNull();
        }

        @Test
        void multiSegmentModulePrefixWithNamedInstance() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.mq1.spring.rabbitmq.host", "spring.rabbitmq"))
                    .isEqualTo("mq1");
        }

        @Test
        void nonForageProperty() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("quarkus.datasource.url", "jdbc"))
                    .isNull();
        }

        @Test
        void noMatchingModulePrefix() {
            assertThat(QuarkusPropertyTranslator.extractPrefix("forage.unknown.property", "jdbc"))
                    .isNull();
        }
    }
