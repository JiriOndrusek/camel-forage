...
class ConfigWriteCommandDeleteTest {
    ...
    void testDeleteOneOfMultipleSameFactoryType() throws Exception {
        ...
        assertThat(props.getProperty("camel.jbang.dependencies.main"))
                .contains("org.apache.camel.forage:forage-jdbc:1.0-SNAPSHOT");
        assertThat(props.getProperty("camel.jbang.dependencies.spring-boot"))
                .contains("org.apache.camel.forage:forage-jdbc-starter:1.0-SNAPSHOT");
        assertThat(props.getProperty("camel.jbang.dependencies.quarkus"))
                .contains("org.apache.camel.forage:forage-quarkus-jdbc-deployment:1.0-SNAPSHOT");

        // MariaDB bean dependency should be preserved
        assertThat(props.getProperty("camel.jbang.dependencies"))
                .contains("org.apache.camel.forage:forage-jdbc-mariadb:1.0-SNAPSHOT");
    }
    ...
    void testDeletePreservesOtherFactoryConfigs() throws Exception {
        ...
        String existingContent =
                ...
                # Dependencies
                camel.jbang.dependencies=org.apache.camel.forage:forage-jdbc-postgresql:1.0-SNAPSHOT,org.apache.camel.forage:forage-jms-artemis:1.0-SNAPSHOT
                camel.jbang.dependencies.main=org.apache.camel.forage:forage-jdbc:1.0-SNAPSHOT,org.apache.camel.forage:forage-jms:1.0-SNAPSHOT
                camel.jbang.dependencies.spring-boot=org.apache.camel.forage:forage-jdbc-starter:1.0-SNAPSHOT,org.apache.camel.forage:forage-jms-starter:1.0-SNAPSHOT
                camel.jbang.dependencies.quarkus=org.apache.camel.forage:forage-quarkus-jdbc-deployment:1.0-SNAPSHOT,org.apache.camel.forage:forage-quarkus-jms-deployment:1.0-SNAPSHOT
                """;
        Files.writeString(propsFile.toPath(), existingContent);
    ...
    void testDeletePreservesNonForageDependencies() throws Exception {
        ...
        String existingContent =
                ...
                camel.jbang.dependencies=com.example:custom-lib:1.0,org.apache.camel.forage:forage-jdbc-postgresql:1.0-SNAPSHOT,com.another:lib:2.0
                camel.jbang.dependencies.main=com.example:custom-main:1.0,org.apache.camel.forage:forage-jdbc:1.0-SNAPSHOT
                """;
        Files.writeString(propsFile.toPath(), existingContent);
