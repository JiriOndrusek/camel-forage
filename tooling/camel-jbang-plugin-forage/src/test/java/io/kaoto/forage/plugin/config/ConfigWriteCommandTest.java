...
class ConfigWriteCommandTest {
    ...
    void testWritePostgresqlConfig() throws Exception {
        ...
        assertThat(props.getProperty("camel.jbang.dependencies"))
                .contains("org.apache.camel.forage:forage-jdbc-postgresql:");
        assertThat(props.getProperty("camel.jbang.dependencies.main")).contains("org.apache.camel.forage:forage-jdbc:");
        assertThat(props.getProperty("camel.jbang.dependencies.spring-boot"))
                .contains("org.apache.camel.forage:forage-jdbc-starter:");
        assertThat(props.getProperty("camel.jbang.dependencies.quarkus"))
                .contains("org.apache.camel.forage:forage-quarkus-jdbc-deployment:");
    }
    ...
    void testWriteIbmMqConfig() throws Exception {
        ...
        assertThat(props.getProperty("camel.jbang.dependencies")).contains("org.apache.camel.forage:forage-jms-ibmmq:");
        assertThat(props.getProperty("camel.jbang.dependencies.main")).contains("org.apache.camel.forage:forage-jms:");
        assertThat(props.getProperty("camel.jbang.dependencies.spring-boot"))
                .contains("org.apache.camel.forage:forage-jms-starter:");
        assertThat(props.getProperty("camel.jbang.dependencies.quarkus"))
                .contains("org.apache.camel.forage:forage-quarkus-jms-deployment:");
    }
    ...
    void testDependenciesPreserveExisting() throws Exception {
        ...
        assertThat(baseDeps).contains("org.apache.camel.forage:forage-jdbc-postgresql:");
        ...
        assertThat(mainDeps).contains("org.apache.camel.forage:forage-jdbc:");
    ...
    void testAddGeminiAgentThenJmsToExistingJdbcConfig() throws Exception {
        ...
        assertThat(baseDepsAfterGemini).contains("org.apache.camel.forage:forage-jdbc-postgresql:1.0-SNAPSHOT");
        assertThat(baseDepsAfterGemini).contains("org.apache.camel.forage:forage-model-google-gemini:");
        ...
        assertThat(mainDepsAfterGemini).contains("org.apache.camel.forage:forage-jdbc:1.0-SNAPSHOT");
        ...
        assertThat(finalBaseDeps).contains("org.apache.camel.forage:forage-jdbc-postgresql:1.0-SNAPSHOT");
        assertThat(finalBaseDeps).contains("org.apache.camel.forage:forage-model-google-gemini:");
        assertThat(finalBaseDeps).contains("org.apache.camel.forage:forage-jms-artemis:");
        ...
        assertThat(finalMainDeps).contains("org.apache.camel.forage:forage-jdbc:1.0-SNAPSHOT");
        assertThat(finalMainDeps).contains("org.apache.camel.forage:forage-jms:");
        ...
        assertThat(finalSpringBootDeps).contains("org.apache.camel.forage:forage-jdbc-starter:1.0-SNAPSHOT");
        assertThat(finalSpringBootDeps).contains("org.apache.camel.forage:forage-jms-starter:");
        ...
        assertThat(finalQuarkusDeps).contains("org.apache.camel.forage:forage-quarkus-jdbc-deployment:1.0-SNAPSHOT");
        assertThat(finalQuarkusDeps).contains("org.apache.camel.forage:forage-quarkus-jms-deployment:");
    }
